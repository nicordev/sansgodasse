...
<section class="content">
	...
	<article>
		<h4>Liste des points clés</h4>

		<p>
			Voici les 5 points clés de la foulée naturelle :
			<ul>
				<li>Posture droite</li>
				<li>Léger déséquilibre vers l’avant</li>
				<li>Poser le pied à la verticale du bassin et non pas devant vous</li>
				<li>L’avant du pied touche le sol en premier</li>
				<li>Sauf en cas de sprint, le talon touche le sol juste après l’avant du pied (quasiment en même temps) </li>
			</ul>
		</p>
		...
		<p>
			...
			<ul>
				<li>Rythme des pas rapide (160 - 180 pas/minute) et constant</li>
				<li>Montez suffisamment les genoux et les talons</li>
				<li>Imaginez que vous enjambez des rondins (plus le rondin est gros, plus vous irez vite)</li>
				<li>Utilisez les fessiers</li>
				<li>Ne mettez pas vos pieds « en canard »</li>
				<li>Ramenez alternativement les coudes vers l’arrière (et pas vers l’avant)</li>
			</ul>
		</p>
	</article>

	<article>
		<h4>Les points clés en détail</h4>

		<h5>Adopter une posture droite</h5>
		...
		<p>
			...
			<ul>
				<li>Vous évitez de vous faire mal au dos</li>
				<li>Vos poumons ont plus de place pour emmagasiner de l’oxygène</li>
				<li>Vous avez un meilleur équilibre</li>
				<li>Vous vous sentez plus sûr de vous</li>
				<li>Vous ne ressemblez plus à une « mamie » quand vous courrez</li>
			</ul>
		</p>

		<h5>Léger déséquilibre vers l’avant</h5>
		...
		<h5>Poser le pied à la verticale du bassin et non devant</h5>
		...
		<figure class="center">
			<div class="superimposed">
				<img src="images/learn2_footstrike.png" alt="Schéma comparatif" />
				<figcaption>Talon vs Avant-pied</figcaption>
			</div>
		</figure>

		<h5>L’avant du pied touche le sol en premier</h5>
		...
		<h5>Le talon touche le sol en second</h5>
	...
	<article>
		<h4>Quelques astuces pour vous aider</h4>

		<h5>Le rythme de vos pas est rapide et constant</h5>
		...
		<h5>Lever les genoux et les talons</h5>
		...
		<h5>Ne mettez pas vos pieds « en canard »</h5>
		...
		<h5>Ramenez alternativement les coudes vers l’arrière</h5>
	...
	<article>
		...
		<p>
	 	...
	 	<h5>La marche statique</h5>

	 	<ol>
	 		<li>Tenez-vous debout, immobile, avec une posture droite</li>
	 		<li>Commencez par marcher sur place, en laissant naturellement vos bras balancer</li>
			<li>En même temps, commencez à lever vos genoux et à ramener vos coudes vers l’arrière</li>
			<li>Faites environ 100 pas sur place tout en étant à l’écoute de vos sensations</li>
	 	</ol>

	 	<p>
	 		Pendant l’exercice, posez-vous les questions suivantes pour vous aider à prendre conscience des points clés :
	 		<ul>
	 			<li>Quelle partie de mon pied touche le sol en premier ?</li>
	 			<li>Est-ce que je me tiens bien droit ?</li>
	 			<li>Est-ce que je lève mes genoux ?</li>
	 			<li>Est-ce que je me sers de mes fessiers ?</li>
	 			<li>Comment je me sens psychologiquement ? Fort ? Détendu ? Confiant ? ou à l’inverse : Faible ? Contraint ? Peu assuré ?</li>
	 		</ul>
	 	</p>
	 	...
	 	<p>
	 		...
	 		<ul>
	 			<li>Quelle partie de mon pied touche le sol en premier ? Là, si tout va bien, c’est l’avant du pied qui touche le sol en premier, naturellement.</li>
	 			<li>Est-ce que je me tiens bien droit ? Si ce n’est pas le cas, relevez la tête, tirez les épaules en arrière, gonflez le torse et cambrez légèrement le bassin.</li>
	 			<li>Est-ce que je lève mes genoux ? Si vous les levez à peine, levez les plus !</li>
	 			<li>Est-ce que je me sers de mes fessiers ? Là il y a un piège. Si vous avez bien réalisez l’exercice sans réfléchir, vous devriez avoir remarqué que vous ne vous servez quasiment pas de vos fessiers. C’est normal, les fessiers nous servent principalement à courir, et non à marcher !</li>
	 			<li>Comment je me sens psychologiquement ? Si vous ne vous sentez pas fort, détendu et confiant, interprétez ceci comme un signe que votre démarche n’est pas correcte. Peut-être que vous ne vous tenez pas assez droit ? Ou alors que vous réfléchissez trop ? Tout en continuant de marcher, redressez-vous, respirez profondément, regardez loin devant vous et cessez un instant de vous focaliser sur votre démarche. Si ça ne va pas mieux, faites le tour des points clé pour voir s’il n’y a pas quelque chose qui cloche. Si, après tout ça, vous ne sentez pas d’amélioration, c’est que le problème n’a rien avoir avec l’exercice et qu’aujourd’hui, ce n’est pas votre jour !</li>
	 		</ul>
	 	</p>
 	...
 	<article>
 		...
 		<p>
 			...
 			<ul>
 				<li>Commencez par marcher sur place et mettez-vous à l’écoute de vos sensations</li>
 				<li>Passez de la marche statique à la course statique</li>
 				<li>Quand vous vous sentez suffisamment confiant, laissez-vous tomber vers l’avant !</li>
 			</ul>
 		</p>
 		...
 		<p class="warning good">
			<strong>Prenez plaisir à courir !</strong>
		</p>
		...
		<p class="warning good">
			<strong>Et voilà pour la méthode ! Bravo pour avoir essayé !</strong>
		</p>
 	</article>

 	<footer class="contentFooter">
		<p>
			N'hésitez pas à laisser vos témoignages ou question dans la rubrique <a href="index.php?page=help">"Entraide"</a>, ça aidera les autres et je pourrais vous répondre.
		</p>
	</footer>
</section>
