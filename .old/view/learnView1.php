...
<section class="content">
	...
	<article>
		...
		<ol>
			<li>Le bitume</li>
			<li>Le béton</li>
			<li>Le sol d’un gymnase</li>
			<li>Le revêtement d’une piste d’athlétisme</li>
			<li>Un chemin en terre</li>
			<li>Une pelouse de jardin</li>
			<li>Un sous-bois</li>
			<li>Un pré</li>
			<li>Une allée de graviers</li>
			<li>Une plage de sable fin</li>
		</ol>
	...
	<article>
		...
		<p>
			Vous êtes peut-être interloqué. Pourtant je peux vous affirmer que j’ai bien toute ma tête et que je n’ai pas fait ce classement par hasard !<br />
			En effet, s’il y a une chose que j’aimerais que vous reteniez de cet article, c’est que le sable est la pire des surfaces pour débuter.<br />
			Vous comprendrez mieux pourquoi une fois que je vous aurai présenté les autres surfaces.
		</p>
	</article>

	<article>
		<h4>Les 2 favoris pour débuter : le bitume et le béton</h4>

		<figure class="spaceAround">
			<div class="superimposed">
				<img src="images/learn1_concrete.jpg" alt="Béton" />
				<figcaption>Une terrasse en béton</figcaption>
			</div>
			<div class="superimposed">
				<img src="images/learn1_road.jpg" alt="Route" />
				<figcaption>Une route de campagne</figcaption>
			</div>
		</figure>
		...
		<ul>
			<li>D’avoir un appui ferme, limitant grandement le risque de faire un faux mouvement</li>
			<li>De sentir pleinement le sol à chaque pas et de bien identifier les points de contact du pied, ce qui est utile pour se rendre compte si notre foulée est correcte et saine (je traiterai de la foulée en détail dans un futur article)</li>
			<li>D’être limité par l’inconfort généré par la surface, comprenez par là qu’au bout d’un moment (qui peut être très court au début) vous aurez mal sous les pieds et vous aurez envie de faire une pause, vous empêchant de sur-solliciter votre corps</li>
		</ul>
		<p>
			Ce dernier point m’amène à vous rappeler un élément très important :
		</p>
		<p class="warning bad">
			<strong>NE JAMAIS FORCER</strong>
		</p>
	...
	<article>
		<h4>Les 4 fantastiques : le sol d’un gymnase, le revêtement d’une piste d’athlétisme, un chemin de terre et la pelouse d’un jardin</h4>

		<figure class="spaceAround">
			<div class="superimposed">
				<img src="images/learn1_path.jpg" alt="Chemin" />
				<figcaption>Petit chemin</figcaption>
			</div>
			<div class="superimposed">
				<img src="images/learn1_grass.jpg" alt="Pelouse" />
				<figcaption>Pelouse</figcaption>
			</div>
		</figure>
	...
	<article>
		<h4>Pour progresser et goûter à la liberté : les sous-bois et les prés</h4>

		<figure class="center">
			<div class="superimposed">
				<img src="images/learn1_forest.png" alt="Sous-bois" />
				<figcaption>Sous-bois</figcaption>
			</div>
		</figure>
		...
		<ul>
			<li>Les pierres (parfois masquées par des feuilles mortes) : intraitables si vous n’êtes pas attentifs ou n’avez pas une foulée suffisamment « légère »</li>
			<li>Les ronces : intraitables quoi que vous fassiez. Évitez de marcher dessus. Heureusement, elles sont facilement repérables en forêt du fait de leurs feuilles vertes qui contrastent avec les couleurs marrons et grises du sol</li>
			<li>Les cosses de fruits tombés : je pense notamment aux faînes (fruit du hêtre), qui peuvent rendre la ballade très désagréable si vous n’êtes pas suffisamment « endurcis »</li>
			<li>Le sol : parfois meuble et irrégulier, peut vous faire faire des faux mouvements si vous n’êtes pas assez attentifs</li>
		</ul>
	...
	<article>
		<h4>Pour les pro : l’allée de gravier et le sable</h4>

		<figure class="spaceAround">
			<div class="superimposed">
				<img src="images/learn1_sand.jpg" alt="Dunes de sable" />
				<figcaption>Le sable fin... Attention les articulations !</figcaption>
			</div>
			<div class="superimposed">
				<img src="images/learn1_gravel.jpg" alt="Graviers" />
				<figcaption>Une allée de graviers c'est pas pour les chochottes !</figcaption>
			</div>
		</figure>
	...
	<article>
		...
		<p>
			Vous êtes maintenant paré pour le cours suivant : <a href="index.php?page=learn&part=2">Les points clés d’une foulée respectueuse de votre corps</a>
		</p>
	</article>

	<article>
		<h4>Bonus : la neige !</h4>

		<p>Pour les plus courageux, la sensation est très sympa !</p>

		<p>
			Qui sait, peut-être qu'avec de l'entrainement vous pourrez même aller à la patinoire pieds nus ! <a href="http://www.sport.be/running/fr/nieuws/article.html?Article_ID=627981" target="_blank" title="Voir cet autre site">-> Record du monde sur glace</a>
		</p>

		<figure class="center">
			<div class="superimposed">
				<img src="images/learn1_snow.jpg" alt="Neige" />
				<figcaption>What else ?</figcaption>
			</div>
		</figure>
	</article>
